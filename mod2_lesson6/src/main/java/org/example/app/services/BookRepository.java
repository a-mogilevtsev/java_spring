...
public class BookRepository implements ProjectRepository<Book>, ApplicationContextAware {
    ...
    public boolean removeItemById(Integer bookIdToRemove) {
        ...
        logger.info("remove book with id - '" + bookIdToRemove + "' completed");
        return true;
    }
    ...
    public boolean removeItemByAuthor(String author) {
        ...
        logger.info("remove book with author - '" + author + author.length() +  "' completed");
        return true;
    }
    ...
    public boolean removeItemByTitle(String title) {
        ...
        logger.info("remove book with title - '" + title + "' completed");
        return true;
    }

                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            case'changedate':
                                ...
                                break;
                            case'recent':
                                getData('/bookshop/booksbydate/page/', {
                                    from: $('[data-refreshfrom]').data('refreshfrom'),
                                    to: $('[data-refreshto]').data('refreshto'),
                                    offset: function() {
                            ...
                            case'popular':
                                ...
                                break;
                            case'genre':
                                getData('/bookshop/genre/page/' + $this.data('refreshid'), {
                                    offset: function() {
                                        var oldOffset = $this.data('refreshoffset');
                                        if(oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                break;
                            case'author':
                                getData('/bookshop/author/' + $this.data('refreshid'), {
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                            case'tag':
                                getData('/bookshop/tag/' + $this.data('refreshid'), {
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                                ...
                                if ($(slick.$slides[slick.$slides.length - 3]).hasClass('slick-active')) {
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                sendData('/bookshop/recommended')
                                                break;
                                            case'recent':
                                                sendData('/bookshop/books/recent')
                                                break;
                                            case'popular':
                                                sendData('/bookshop/popular')
                                                break;
                                        }
                                    }
                                }
